...
When searching in SQL, use LIKE, LOWER(), e.g: To check if ticker equals to "Xyz", then use: LOWER(ticker) LIKE LOWER('%Xyz%'). Never use equals sign for a keyword search.
